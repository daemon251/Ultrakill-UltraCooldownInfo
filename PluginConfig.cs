...
{
    public static float movingHUDAmount = 1f;
    public enum KeyEnum
    {
    ...
    public static void CreateConfig()
    {
        ...
        FloatField movingHUDAmountField = new FloatField(globalSettingsPanel, "Moving HUD stability", "MovingHUDAmount", 1f, 0f, 100f);
        movingHUDAmountField.onValueChange += (FloatField.FloatValueChangeEvent e) => { movingHUDAmount = e.value; };
        movingHUDAmount = movingHUDAmountField.value;
        ...
        foreach (int i in configOrder)
        {
            ...
            BoolField movingHUDField = new BoolField(newPanel, "Moving HUD", UCIWepConf.name.Replace(" ", string.Empty) + "MovingHUD", false);
            movingHUDField.onValueChange += (BoolField.BoolValueChangeEvent e) => { UCIWepConf.movingHUD = e.value; };
            UCIWepConf.movingHUD = movingHUDField.value;
        }
    }
}